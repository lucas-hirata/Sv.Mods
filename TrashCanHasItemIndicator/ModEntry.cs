...
namespace Sv.TrashCanHasItemIndicator
{
    internal sealed class ModEntry : Mod
    {
        ...
        private void OnRenderedWorld(object sender, RenderedWorldEventArgs e)
        {
            ...
            //DrawItemBubbleForTrashCans(GetTrashCans());
        }

        //private static List<Tree> GetTrashCans()
        //{
        //    StardewValley.Object obj = new();
        ...
        //private static void DrawItemBubbleForTrashCans(List<Tree> treeList)
        //{
        //    foreach (Tree tree in treeList)
        //    {
        //        if (!tree.hasSeed.Value) continue;

        //        DrawItemBubble(Game1.spriteBatch, tree);
        //    }
        //}

        //public static void DrawItemBubble(SpriteBatch spriteBatch, Tree tree)
        //{
